...
<html>
    ...
    <body class="bg-blue-100">
        ...
        %>
        <header>
            <nav class="fixed px-4 lg:px-6 py-2.5 top-0 z-50 w-full bg-blue-400 shadow border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
        ...
        <div class="fixed z-50 w-full h-16 max-w-lg -translate-x-1/2 bg-white border border-gray-200 rounded-full bottom-4 left-1/2 dark:bg-gray-700 dark:border-gray-600">
            <div class="grid h-full max-w-lg grid-cols-5 mx-auto">
                ...
                <div id="doubleDropdown" class="z-10 hidden bg-blue-300 divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
                    <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="doubleDropdownButton">
                        <li>
                            <a href="apllnAccepted.jsp" class="block px-4 py-2 hover:bg-blue-200 dark:hover:bg-gray-600 dark:hover:text-white">Accepted</a>
                        </li>
                        <li>
                            <a href="apllnRejected.jsp" class="block px-4 py-2 hover:bg-blue-200 dark:hover:bg-gray-600 dark:hover:text-white">Rejected</a>
                        </li>
                        <li>
                            <a href="apllnPending.jsp" class="block px-4 py-2 hover:bg-blue-200 dark:hover:bg-gray-600 dark:hover:text-white">Pending</a>
                        </li>
                    </ul>
                </div>
                ...
                <div id="settingDropdown" class="z-10 hidden bg-blue-300 divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
                    <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="settingDropdownButton">
                        <li>
                            <a href="studentChangepass.jsp" class="block px-4 py-2 hover:bg-blue-200 dark:hover:bg-gray-600 dark:hover:text-white">Change Password</a>
                        </li>
                ...
                <!--                        user menu drawer-->
                <div class="z-50 hidden my-4 w-44 text-base list-none bg-blue-300 divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600" id="dropdown-user">
                    ...
                    <ul class="py-1" role="none">
                        <li>
                            <a href="studentProfile.jsp" class="block px-4 py-2 text-sm text-black hover:bg-blue-200 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem">My Profile</a>
                        </li>
                        
                        <li>
                            <a href="Logout" class="block px-4 py-2 text-sm text-black hover:bg-blue-200 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem">Sign out</a>
                        </li>
                    </ul>
                </div>
            </div>
...
<div role="status" class="space-y-8 mb-6 animate-pulse md:space-y-0 md:space-x-8 md:flex md:items-center">
