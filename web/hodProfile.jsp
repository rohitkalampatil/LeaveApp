...
<html>
    <head>
        ...
        <title>Dashboard -<%= session.getAttribute("userid")%></title>
    </head>
    <body>
        ...
        <%  //   no chache stored, page will not display after logout
            ...
            if (session.getAttribute("branch") == null || session.getAttribute("userid") == null || session.getAttribute("hodname") == null) {
